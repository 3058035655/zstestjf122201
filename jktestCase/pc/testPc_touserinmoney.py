...
touserinmoney = get_xls("pcChongzhiCase.xls", "touserinmoney")
# print(accountRecharge)
b=BasePage()
url1=b.get_url()
@paramunittest.parametrized(*touserinmoney)
class touserinmoneyTest(unittest.TestCase):
    ...
    def test_login(self):
        ...
        r2 = requests.post(url2,verify=False,cookies=c)  # 发送请求
