...
class Test_Tjblackname (unittest.TestCase):
    ...
    def test_Login(self):
        ...
        for d in datas:
            with self.subTest (data=d):
                ...
                # driver.find_element_by_id ("type").find_elements_by_tag_name ("option")[8].click ();  #
                # driver.find_element_by_id ("type").find_elements_by_tag_name ("option")[10].click ();  # 钱袋子内部员工推荐奖励
                driver.find_element_by_id ("type").find_elements_by_tag_name ("option")[7].click ();  # 充值ok PCok ios 不ok
