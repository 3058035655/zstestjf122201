...
class Sign(Exception):
    ...
    def sign(sign_dict, private_key=None, encrypt_way='MD5'):
        ...
        return Sign.encrypt(string, salt=private_key, encrypt_way=encrypt_way)
    ...
    def encrypt(string, salt='', encrypt_way='MD5'):
        ...
        if encrypt_way.upper() == 'MD5':
            ...
            logger.exception(Sign('请输入正确的加密方式，目前仅支持 MD5 或 SHA1'))
            return False
...
if __name__ == '__main__':
    print(Sign.encrypt('100000307111111'))
    s=Sign.sign(d, private_key='a',encrypt_way='MD5')
    print(s)